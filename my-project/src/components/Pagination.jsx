...
const Pagination = ({ currentPage, totalPages, onNext, onPrevious }) => {
  return (
    <div className="flex justify-between mt-4">
      <p className="px-4 py-2 text-gray-950 text-lg dark:text-stone-200 ">
        Pages
      </p>
      <button
        onClick={onPrevious}
      ...
      <button className="px-4 py-2 mx-4 text-lg font-semibold text-gray-950 dark:text-stone-200">
        {currentPage}
      </button>
      <button
        onClick={onNext}
